    ...
    with open(json_relationships, "r") as read_file:
        ...
        for s in data["scans"]:
            ...
            for k in s["objects"].keys():
                ...
                scene_graphs[scan]['objects'].append(scene_graphs_obj[scan]['objects'])
...
def read_relationships(read_file):
    ...
    # return relationships
        ...
        for s in data['scans']:
            ...
            for relationship in relationships:
                relationship[2] -= 1
                relationships_lst.append(relationship)
            if scan not in scene_graphs:
                scene_graphs[scan] = {}
                scene_graphs[scan]['objects'] = []
                print("WARNING: no objects for this scene")
            ...
            #             inst = i
            #             break
            scene_graphs[scan]['objects']=s['objects']
                # scene_graphs[scan]['objects'].append(scene_graphs_obj[scan]['objects'])
    ...
    return relationships, scene_graphs
