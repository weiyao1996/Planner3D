...
if __name__ == "__main__":
    ...
    # v1_pc_list = []
    v2_path = "/home/weiy1/code/commonscenes/experiments/g2sv2/all_demo/renders/g2sv2180_small/object_meshes" # CommonScenes results
    v2_pc_list = []
    gt_path = "/home/weiy1/code/commonscenes/Data/gt_fov90_h8_obj_meshes/test/small" # ground truth results
    gt_pc_list = []
    ...
    for cat_id in range(3, len(categories)):
        ...
        v2_pcs = v2_pcs[:116]
        print(f'loaded {v2_pcs.size(0)} {categories[cat_id]} from v2')

        gt_pcs = collect_pcs(gt_path, categories[cat_id], number=5000, transform=False, visual=False)
        gt_pcs = gt_pcs[:116]
        print(f'loaded {v2_pcs.size(0)} {categories[cat_id]} from gt')
