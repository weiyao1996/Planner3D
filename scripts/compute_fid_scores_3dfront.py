...
def main(argv):
    ...
    if args.compare_trainval:
        ...
        args.path_to_real_renderings = "/home/weiy1/code/commonscenes/Data/sdf_fov90_h8/small/test"
        args.path_to_synthesized_renderings = "/home/weiy1/code/commonscenes/experiments/g2sv2/all_demo/renders/g2sv2180_small_4/render_imgs/v2"
        # test_real = ThreedFrontRenderDataset(CachedThreedFront(
        #     args.path_to_real_renderings,
        #     config=config,
    ...
    path_root_tmp = "/home/weiy1/code/commonscenes/experiments/g2sv2/all_demo"
    print("Generating temporary a folder with test_real images...")
    path_to_test_real = path_root_tmp + "/fid_kid_tmp/real" # /tmp/test_real
    ...
    path_to_test_fake = path_root_tmp + "/fid_kid_tmp/fake" #/tmp/test_fake/
