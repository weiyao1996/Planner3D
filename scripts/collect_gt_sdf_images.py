...
from diff_utils.util_3d import render_sdf, render_mesh, sdf_to_mesh
from helpers_util import pytorch3d_to_trimesh, fit_shapes_to_box_v2

## Need to download 3D-FUTURE-SDF
# files from SG-FRONT
obj_info_path_test = "/home/weiy1/code/commonscenes/Data/obj_boxes_all_test.json"
obj_info_path_trainval = "/home/weiy1/code/commonscenes/Data/obj_boxes_all_trainval.json"
rel_trainval_file = "/home/weiy1/code/commonscenes/Data/relationships_all_trainval.json"
rel_test_file = "/home/weiy1/code/commonscenes/Data/relationships_all_test.json"
class_file = "/home/weiy1/code/commonscenes/Data/classes_all.txt"

bath = '/home/weiy1/code/commonscenes/Data/sdf_fov90_h8'
cat = {}
large = False
without_lamp = False
no_stool = False
mapping_file = "/home/weiy1/code/commonscenes/Data/mapping.json" if not no_stool else "/home/weiy1/code/commonscenes/Data/mapping_no_stool.json"
if without_lamp:
    bath += '_wo_lamp'
if no_stool:
    bath += '_no_stool'
...
for info in rel['scans']:
    ...
    for k, v in info["objects"].items():
        ...
        sdf_path = os.path.join(obj_info[scan_id][k]["model_path"].replace('3D-FUTURE-model', "3D-FUTURE-SDF").rsplit('/', 1)[0], 'ori_sample_grid.h5')
        new_sdf_path = '/home/weiy1/code/commonscenes/Data' + sdf_path[36:]
        h5_f = h5py.File(new_sdf_path, 'r')
