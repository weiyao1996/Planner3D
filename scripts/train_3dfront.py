...
parser.add_argument('--exp', default='/home/weiy1/code/commonscenes/experiments/g2sv2/all_oursv1_wo_llm_w_iou', help='experiment name')
...
parser.add_argument('--weight_D_box', default=0.1, type=float, help="Box Discriminator") # 0.1
parser.add_argument('--with_changes', default=True, type=bool_flag)
parser.add_argument('--loadmodel', default=True, type=bool_flag)
parser.add_argument('--loadepoch', default=150, type=int, help='only valid when loadmodel is true') #90
...
def train():
    ...
    for epoch in range(start_epoch, args.nepoch):
        ...
        for i, data in enumerate(dataloader, 0):
            ...
            a = []
            start_idx = 0
            for end_idx in dec_objs_to_scene:
                sub_tensor = orig_box[start_idx:end_idx + 1]
                if len(sub_tensor) > 0:
