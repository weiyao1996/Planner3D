...
sys.path.append("/home/weiy1/code/commonscenes/ATISS-master/scene_synthesis/")
from datasets import filter_function
from datasets.threed_front import ThreedFront
from datasets.threed_front_dataset import dataset_encoding_factory
...
def main(argv):
    ...
    parser.add_argument(
        "--output_directory",
        default="/home/weiy1/code/commonscenes/SG-FRONT/processed/",
        help="Path to output directory"
    )
    parser.add_argument(
        "--path_to_3d_front_dataset_directory",
        default="/home/weiy1/code/commonscenes/SG-FRONT/3D-FRONT/",
        help="Path to the 3D-FRONT dataset"
    )
    parser.add_argument(
        "--path_to_3d_future_dataset_directory",
        default="/home/weiy1/code/commonscenes/SG-FRONT/3D-FUTURE/3D-FUTURE-model/",
        help="Path to the 3D-FUTURE dataset"
    )
    parser.add_argument(
        "--path_to_model_info",
        default="/home/weiy1/code/commonscenes/SG-FRONT/3D-FUTURE/model_info.json",
        help="Path to the 3D-FUTURE model_info.json file"
    )
    parser.add_argument(
        "--path_to_floor_plan_textures",
        # default="/home/weiy1/code/commonscenes/SG-FRONT/3D-FRONT-texture/",
        default="/home/weiy1/code/commonscenes/ATISS-master/demo/floor_plan_texture_images/",
